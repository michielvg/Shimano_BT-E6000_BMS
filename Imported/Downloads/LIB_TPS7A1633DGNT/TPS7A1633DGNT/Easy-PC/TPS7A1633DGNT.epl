...
(library Library_1
	...
	(compDef "TPS7A1633DGNT" (originalName "TPS7A1633DGNT") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "FB/DNC") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "DELAY") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/tps7a16.pdf")
		(attr "Height" "1.1 mm")
	)
