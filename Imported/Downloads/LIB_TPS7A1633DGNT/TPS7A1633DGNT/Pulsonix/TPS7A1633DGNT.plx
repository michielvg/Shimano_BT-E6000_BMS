...
(library Library_1
	...
	(padStyleDef "r192_160"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.6) (shapeHeight 1.92))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SOP65P490X110-9N" (originalName "SOP65P490X110-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r192_160) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "TPS7A1633DGNT" (originalName "TPS7A1633DGNT")
	...
	(compDef "TPS7A1633DGNT" (originalName "TPS7A1633DGNT") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "OUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "FB/DNC") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "DELAY") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS7A1633DGNT"))
		...
		(attr "Mouser Part Number" "595-TPS7A1633DGNT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS7A1633DGNT?qs=KC2rBGieF4pkwFmfmKPfSg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS7A1633DGNT")
		(attr "Description" "Texas Instruments TPS7A1633DGNT, LDO Voltage Regulator, 100mA, 3.3 V +/-2%, 3  60 Vin, 8-Pin MSOP")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tps7a16.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS7A1633DGNT.stp")
